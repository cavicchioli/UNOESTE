%RESOLUÇÃO DO PROBLEMA DOS MISSIONÁRIOS E CANIBAIS
...
%controlando apenas as quantidades de Missionários e Canibais referentes
%a margem da esquerda, se saiu da esquerda para a direita então
%subtração.
...
%controlando apenas as quantidades de Missionários e Canibais referentes
%a margem da esquerda, se saiu da direita para a esquerda então adição.
