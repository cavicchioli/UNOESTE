...
%Encontra o elemento de uma lista a partir do indice
encontraeElem(0, [H|_], H):- !.
encontraeElem(I, [_|T], E):- X is I - 1, encontraeElem(X, T, E).

%Remove um elemento da lista a partir do indice
removeind(0,[_|T],T):- !.
