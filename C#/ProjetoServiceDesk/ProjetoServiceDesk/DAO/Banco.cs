...
namespace ProjetoServiceDesk.DAO
{
    ...
    internal class Banco
    {
        ...
        protected Banco()
        {
            _strConexao = @"Data Source=localhost\sqlexpress;Initial Catalog=ServiceDesk;Persist Security Info=True;User ID=sa;Password=123";
            //_strConexao = @"Data Source=localhost\sqlexpress;Initial Catalog=ServiceDesk;Persist Security Info=True;User ID=sa;Password=a12345z";
